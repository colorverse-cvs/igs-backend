...
export class UpdateProductDto {
  ...
  @ApiPropertyOptional({ example: '66fbf6f90123456789abc001' })
  @IsOptional()
  @IsString()
  categoryId?: string;
  ...
  tags?: string[];
    ...
    @ApiPropertyOptional({
      example: ['/public/products/abc.jpg', '/public/products/def.jpg'],
      description: 'Existing image URLs to remove from product',
      type: [String],
    })
    @IsOptional()
    @IsArray()
